...
public class CommonArchives {
    ...
    public static List<JavaArchive> getCommonWebFragmentArchives() {
        JavaArchive javaArchive1 = ShrinkWrap.create(JavaArchive.class, "fragment-1.jar")
                ...
                .addAsResource(CommonArchives.class.getClassLoader().getResource("com/sun/ts/tests/servlet/pluggability/common/web-fragment_1.xml"),
                        "META-INF/web-fragment.xml");
        JavaArchive javaArchive2 = ShrinkWrap.create(JavaArchive.class, "fragment-2.jar")
                .addClasses(RequestListener2.class)
                .addAsResource(CommonArchives.class.getClassLoader().getResource("com/sun/ts/tests/servlet/pluggability/common/web-fragment_2.xml"),
                        "META-INF/web-fragment.xml");
        JavaArchive javaArchive3 = ShrinkWrap.create(JavaArchive.class, "fragment-3.jar")
                .addClasses(RequestListener3.class)
                .addAsResource(CommonArchives.class.getClassLoader().getResource("com/sun/ts/tests/servlet/pluggability/common/web-fragment_3.xml"),
                        "META-INF/web-fragment.xml");
        JavaArchive javaArchive4 = ShrinkWrap.create(JavaArchive.class, "fragment-4.jar")
                .addClasses(RequestListener4.class)
                .addAsResource(CommonArchives.class.getClassLoader().getResource("com/sun/ts/tests/servlet/pluggability/common/web-fragment_4.xml"),
                        "META-INF/web-fragment.xml");
        JavaArchive javaArchive5 = ShrinkWrap.create(JavaArchive.class, "fragment-5.jar")
                .addClasses(RequestListener5.class)
                .addAsResource(CommonArchives.class.getClassLoader().getResource("com/sun/ts/tests/servlet/pluggability/common/web-fragment_5.xml"),
                        "META-INF/web-fragment.xml");
